...
// CODE HERE
var myFriends = ["Johnny", "Josh", "Riker", "Kaleb"];
/**
 * #6
 *
...
var trueFriends = [];
peopleIknow.forEach(function(value){
  if(value.friend == true){
    trueFriends.push(value);
  }
})
/**
 * #10
...
function indexFinder(){
  indexes = randomNumbers.map(function(value,index){
      return index;
  })
};
